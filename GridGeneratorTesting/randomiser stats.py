...
def analyse_dataset(dataset_file, grid_size):
    ...
    # the grids are generated in an appropriately random manner. If every possible unique grid is created, each with
    ...
    print("There are " + str(num_solvable_combinations) + " possible (solvable) combinations of\n"
